...
/// \file   MID/Raw/src/RawDataAggregator.cxx
/// \brief  MID raw data aggregator
...
ColumnData& RawDataAggregator::FindColumnData(uint8_t deId, uint8_t columnId, size_t firstEntry)
{
...
void RawDataAggregator::addData(const LocalBoardRO& loc, size_t firstEntry)
{
...
void RawDataAggregator::process(gsl::span<const LocalBoardRO> localBoards, gsl::span<const ROFRecord> rofRecords)
{
