...
/// \file   MID/Workflow/src/clusters-reader-workflow.cxx
/// \brief  DPL workflow to send MID clusters read from a root file
...
WorkflowSpec defineDataProcessing(const ConfigContext& config)
{
  ...
  return WorkflowSpec{o2::mid::getClusterReaderSpec(useMC)};
}
