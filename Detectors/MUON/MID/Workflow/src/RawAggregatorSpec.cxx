...
{
  std::vector<of::InputSpec> inputSpecs{of::InputSpec{"mid_decoded", "MID", "DECODED"}, of::InputSpec{"mid_decoded_rof", "MID", "DECODEDROF"}};
  std::vector<of::OutputSpec> outputSpecs{of::OutputSpec{"MID", "DATA"}, of::OutputSpec{"MID", "DATAROF"}};
