...
bool readFile(std::string filename, o2::mid::Decoder& decoder, std::vector<o2::mid::LocalBoardRO>& data, std::vector<o2::mid::ROFRecord>& rofRecords, unsigned long int nHBFs)
{
